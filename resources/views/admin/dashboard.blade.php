...
@section('content')
    <div class="ui container" style="margin-top: 2em;">
        ...
        <div class="ui message">
            <p>Here you can manage all users, view logs, transactions and fiscal records.</p>
        </div>

        <div class="ui menu">
            <a href="{{ route('dashboard') }}" class="ui ui-button ui-corner-all"><i class="ui-icon ui-icon-home"></i>To regular
                dashboard</a>
            <a href="{{ route('admin.users') }}" class="ui ui-button ui-corner-all"><i class="ui-icon ui-icon-person"></i>Manage Users</a>
            <a href="{{ route('admin.logs') }}" class="ui ui-button ui-corner-all"><i class="ui-icon ui-icon-script"></i>View Logs</a>
            ...
            <a href="{{ route('admin.fiscal_records.index') }}" class="ui ui-button ui-corner-all"><i
                    class="ui-icon ui-icon-document"></i>View Fiscal Records</a>
