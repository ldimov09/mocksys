...
return [
    ...
    */
    ...
    'enum' => 'Данните в полето :attribute са невалидни.',
    'exists' => 'Данните в полето :attribute са невалидни.',
    ...
    'in' => 'Данните в полето :attribute са невалидни.',
    ...
    'not_in' => 'Данните в полето :attribute са невалидни.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Данните в полето :attribute са се появили в изтичане на данни. Моля, опитайте отново.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'sender_card_number' => 'номер на карта на изпращача',
        'transaction_id' => 'ID на транзакцията',
        'total' => 'общо',
        'fiscal_key' => 'фискален ключ',
        'items' => 'артикули',
        'payment' => 'плащане',
        'company_id' => 'ID на фирма',
        'cash_register' => 'каса номер',
        'paid' => 'платено',
        'page_width' => 'ширина на хартията',
        'role' => 'роля',
    ],
];
